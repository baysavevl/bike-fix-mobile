	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___21
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  21
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___21_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___21;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_6_7_8_plus___21);

		
		_bg__iphone_6_7_8_plus___21 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___21);
		...
		about_1_2_km = (TextView) findViewById(R.id.about_1_2_km);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___21_activity.this,
						iphone_6_7_8_plus___22_activity.class);
