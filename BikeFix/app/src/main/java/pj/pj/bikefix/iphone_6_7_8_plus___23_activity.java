	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___23
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  23
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___23_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___23;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_6_7_8_plus___23);

		
		_bg__iphone_6_7_8_plus___23 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___23);
		...
		about_700_m = (TextView) findViewById(R.id.about_700_m);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___23_activity.this,
						iphone_6_7_8_plus___24_activity.class);
