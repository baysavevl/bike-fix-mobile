	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___24
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  24
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___24_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___24;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_6_7_8_plus___24);

		
		_bg__iphone_6_7_8_plus___24 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___24);
		...
		about_300_m = (TextView) findViewById(R.id.about_300_m);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___24_activity.this,
