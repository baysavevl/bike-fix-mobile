	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___22
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  22
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___22_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___22;
	...
	private TextView _56_l__v_n_vi_t__t_ng_nh_n_ph___qu_n_9__h__ch__minh_;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_6_7_8_plus___22);

		
		_bg__iphone_6_7_8_plus___22 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___22);
		...
		about_1_km = (TextView) findViewById(R.id.about_1_km);
		...
		_56_l__v_n_vi_t__t_ng_nh_n_ph___qu_n_9__h__ch__minh_ = (TextView) findViewById(R.id._56_l__v_n_vi_t__t_ng_nh_n_ph___qu_n_9__h__ch__minh_);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___22_activity.this,
						iphone_6_7_8_plus___23_activity.class);
