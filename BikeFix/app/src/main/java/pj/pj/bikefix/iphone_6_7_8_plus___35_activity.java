	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___35
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  35
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___35_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___35;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iphone_6_7_8_plus___35);

		
		_bg__iphone_6_7_8_plus___35 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___35);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___35_activity.this,
						iphone_6_7_8_plus___36_activity.class);
