	 ...
	 *
	 *	@desc 		
	 *	@file 		iphone_6_7_8_plus___33
	 *	@date 		0
	 *	@title 		iPhone 6/7/8 Plus  33
	 *	@author 	
	 *	@keywords 	
...
public class iphone_6_7_8_plus___33_activity extends AppCompatActivity {

	
	private View _bg__iphone_6_7_8_plus___33;
	...
	private ImageView nopath___copy__6__ek1;
	private TextView _51a___1256_ek1;
	private ImageView nopath___copy__4__ek1;
	private ImageView nopath___copy__7__ek1;
	private TextView th_ng_b_nh_xe_ek1;
	private TextView honda_dream_ek1;
	private TextView ph_m_th__ng_c_h__ek2;
	private TextView b__c_n_v_o__inh__c_n_thay_to_n_b___ru_t_b_nh_xe_ek1;

	@Override
	public void onCreate(Bundle savedInstanceState) {

		super.onCreate(savedInstanceState);
		setContentView(R.layout.iphone_6_7_8_plus___33);

		
		_bg__iphone_6_7_8_plus___33 = (View) findViewById(R.id._bg__iphone_6_7_8_plus___33);
		...
		nopath___copy__6__ek1 = (ImageView) findViewById(R.id.nopath___copy__6__ek1);
		_51a___1256_ek1 = (TextView) findViewById(R.id._51a___1256_ek1);
		nopath___copy__4__ek1 = (ImageView) findViewById(R.id.nopath___copy__4__ek1);
		nopath___copy__7__ek1 = (ImageView) findViewById(R.id.nopath___copy__7__ek1);
		th_ng_b_nh_xe_ek1 = (TextView) findViewById(R.id.th_ng_b_nh_xe_ek1);
		honda_dream_ek1 = (TextView) findViewById(R.id.honda_dream_ek1);
		ph_m_th__ng_c_h__ek2 = (TextView) findViewById(R.id.ph_m_th__ng_c_h__ek2);
		b__c_n_v_o__inh__c_n_thay_to_n_b___ru_t_b_nh_xe_ek1 = (TextView) findViewById(R.id.b__c_n_v_o__inh__c_n_thay_to_n_b___ru_t_b_nh_xe_ek1);
		...
		handler.postDelayed(new Runnable() {
			public void run() {
				...
				Intent intent = new Intent(iphone_6_7_8_plus___33_activity.this,
						iphone_6_7_8_plus___34_activity.class);
